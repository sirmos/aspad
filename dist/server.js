...
<p style="color:#6b6058;font-size:13px;">Built for the OKX.AI Genesis Hackathon · #OKXAI</p>
    ...
    try {
        ...
        const result = {
            name: spec.name,
            files: {
                "server.ts": (0, generateServer_1.generateServerCode)(spec),
                "listing.md": (0, generateListing_1.generateListing)(spec),
                "registration-prompts.md": (0, generatePrompts_1.generatePrompts)(spec),
                "demo-script.md": (0, generateDemoScript_1.generateDemoScript)(spec),
            },
        };
        res.writeHead(200);
