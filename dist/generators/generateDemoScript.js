...
exports.generateDemoScript = generateDemoScript;
function generateDemoScript(spec) {
...
One line on who this helps and why they would pay ${spec.pricingModel === "paid" ? `${spec.priceUsdt} USDT` : "nothing"} for it.
